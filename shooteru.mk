...
PRODUCT_COPY_FILES += \
    ...
    device/htc/shooteru/dsp/soundimage/Sound_Beats.txt:system/etc/soundimage/Sound_Beats.txt \
    device/htc/shooteru/dsp/soundimage/Sound_MFG.txt:system/etc/soundimage/Sound_MFG.txt \
